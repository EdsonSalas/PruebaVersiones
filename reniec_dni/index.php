...
<body>
    <center>
        ...
        <div class="btn-group">
            ...
            <button type="button" class="btn btn-dark" id="buscardni">
		...
		<button type="button" class="btn btn-dark" id="guardardni">
                Gardar en la base de datos
        </button>
    </center>
</body>
        ...
        $.ajax({
           ...
           success:function(r){
            if(r.numeroDocumento==dni){
                ...
                alert("El dni no existe o está mal escrito");
            }
                console.log(r.numeroDocumento);
                console.log(r.apellidoPaterno);
				console.log(r.apellidoMaterno);
				console.log(r.nombres);
           }
